...
export type ProcessFetchHeadersOptions = Pick<FetchOptions, 'isAsync' | 'host' | 'data'>;
export interface ProcessedFetchHeaders extends Record<string, string | undefined> {
    accept: string;
    date: string;
    host: string;
    'user-agent': string;
